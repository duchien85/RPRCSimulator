...
public class Simulator extends ApplicationAdapter
{
    ...
    public static final float MAX_INC_POWER = 40f;
                    ...
                    server.addListener(new Listener()
                    {
                        ...
                        public void received(Connection con, Object obj)
                        {
                            ...
                            else if(obj instanceof Position)
                            {
                                ...
                                //powerPerc  - percent 0-100% for turning power, 100 means maximum possible turn
                                ...
                                float prop4Speed = currentAcPower;//bottom right

                                /*amount of power from percent*/
                                float powerFromPerc = powerPerc * MAX_INC_POWER / 100;
                                ...
                                if(Math.abs(angle) > 90)//joystick bottom, ascending nose up
                                {
                                    ...
                                    if(angle > 0)//right
                                    {
                                        prop3Speed = Math.max(MAX_PROPELLER_SPEED, prop3Speed + powerFromPerc);
                                        prop1Speed = Math.max(MAX_PROPELLER_SPEED, prop1Speed);
